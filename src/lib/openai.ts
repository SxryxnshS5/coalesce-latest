import { AnalysisBundle, TraitScores } from './types'
...
async function chatStream(
  ...
  function extractText(obj: any): string {
    // Chat Completions stream sends delta objects
  ...
  while (true) {
    ...
    let idx: number
    // Stream is a sequence of lines separated by \n\n, each beginning with "data: "
